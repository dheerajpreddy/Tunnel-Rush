  ...
  for(var k = 0; k< buffers.length; k++) {
    {
      ...
      const stride = 0;
      const offset = 0;
      gl.bindBuffer(gl.ARRAY_BUFFER, buffers[k].position);
    ...
    // the texture coordinate buffer into the textureCoord attribute.
    {
      ...
      const stride = 0;
      const offset = 0;
      gl.bindBuffer(gl.ARRAY_BUFFER, buffers[k].textureCoord);
      gl.vertexAttribPointer(
    ...
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, buffers[k].indices);
